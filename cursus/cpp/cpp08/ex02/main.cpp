...
int main()
{
    std::cout << YELLOW << "\n========== 1. SUBJECT TEST (MutantStack) ==========" << RESET << std::endl;
    ...
    std::cout << "Size after pop: " << GREEN << mstack.size() << RESET << std::endl;
    ...
    std::cout << YELLOW << "\n========== 2. EQUIVALENT TEST (std::list) ==========" << RESET << std::endl;
    
    std::list<int> list_stack;
    list_stack.push_back(5);
    list_stack.push_back(17);
    
    std::cout << "Top element: " << GREEN << list_stack.back() << RESET << std::endl;
    
    list_stack.pop_back();
    
    std::cout << "Size after pop: " << GREEN << list_stack.size() << RESET << std::endl;
    ...
    std::cout << YELLOW << "\n========== 3. REVERSE ITERATOR TEST (MutantStack) ==========" << RESET << std::endl;
    
    std::cout << CYAN << "Stack content (top to bottom using rbegin/rend):" << RESET << std::endl;
